            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="mb-3">Log In to <span class="brand-name">ultiblob</span></h1>
                            ...
                            <div class="form">
                                ...
                                <div class="d-sm-flex justify-content-between">
                                    ...
                                    <div class="field-wrapper">
                                        <button type="submit" class="btn btn-primary log_in" value="" name="log_in">Log
                                            In</button>
                                    </div>
                        ...
                        <p class="terms-conditions " style="visibility:hidden;">© 2020 All Rights Reserved. <a
                                href="dashboard.php">CORK</a> is a product of Designreset. <a
