...
<div class="px-3 py-5">
    ...
    <div class="row mt-4">
        <div class="col-12 col-sm-12 col-md-6 col-lg-6">
            <h6>Blog Title</h6>
            <input type="text" name="blog_name" class="form-control" value="<?=$row['blog_title'];?>" placeholder="Enter Title..." id="">
        ...
        <div class=" d-block col-12 col-sm-12 col-md-6 col-lg-12 mt-4">
            <h6>Description</h6>
            <textarea name="blog_description" placeholder="Write text...." id="" rows="12" class="form-control" style="resize: none;"><?=$row['blog_description'];?></textarea>
        </div>
        ...
        <form action="./handlers/add_handler.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="px-3 py-5">
                ...
                <div class="row mt-4">
                    ...
                    <div class=" d-block col-12 col-sm-12 col-md-6 col-lg-12 mt-4">
                        <h6>Description</h6>
                        <textarea name="blog_description" placeholder="Write text...." id="" rows="12" class="form-control" style="resize: none;"></textarea>
                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="dropdown d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a class=" action-edit text-primary" href="createblog.php?edit_blog=<?= $row['blog_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit-3">
                                                                <path d="M12 20h9"></path>
                                                                <path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path>
                                                            </svg>Edit</a>

                                                        <a class="action-delete text-danger" href="./handlers/delete_handler.php?delete_blog=<?= $row['blog_id']; ?>"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-trash">
